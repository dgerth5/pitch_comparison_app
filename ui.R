                          ...
                          fluidPage(
                            fluidRow(
                              column(4,
                                     ...
                                     numericInput("H_Rel", "H_Rel", value = -1.5),
                                     numericInput("V_Rel", "V_Rel", value = 6.0)),
                              column(4,
                                     h3("Fastball Characteristics"),
                                     selectInput("fastball_type", "Primary Fastball Type", choices = c("FF", "SI", "FC")),
                                     numericInput("velo", "Velo", value = 93),
                                     numericInput("H_Break", "H_Break", value = -7),
                                     numericInput("V_Break", "V_Break", value = 15)),
                              column(4,
